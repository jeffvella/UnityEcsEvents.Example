...
public static class UnityColors
{
    ...
    {
        var r = (byte) ((ulong) (argb >> 16) & byte.MaxValue);
        var g = (byte) ((ulong) (argb >> 8) & byte.MaxValue);
        var b = (byte) ((ulong) argb & byte.MaxValue);
        var a = (byte) ((ulong) (argb >> 24) & byte.MaxValue);
    ...
    {
        var num1 = color.r * 255 / byte.MaxValue;
        var num2 = color.g * 255 / byte.MaxValue;
        var num3 = color.b * 255 / byte.MaxValue;
        var num4 = num1;
        var num5 = num1;
        if (num2 > (double) num4)
            num4 = num2;
