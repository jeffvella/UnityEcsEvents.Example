...
namespace Vella.SimpleBurstCollision
{
    ...
    public static class BurstSphereColliderExtensions
    {
        ...
        public static BurstBaseCollider ToBaseCollider(this BurstSphereCollider sphere)
        {
            return new BurstBaseCollider {Type = BurstColliderType.Sphere, Sphere = sphere};
        }

        public static BurstBaseCollider ToBaseCollider(this BurstSphereCollider sphere, int id)
        {
            return new BurstBaseCollider {Type = BurstColliderType.Sphere, Sphere = sphere, Id = id};
        }
    }
}