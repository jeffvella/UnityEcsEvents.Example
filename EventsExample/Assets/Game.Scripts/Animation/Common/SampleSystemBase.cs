...
public abstract class SampleSystemBase<TSampleSetup, TSampleData, TAnimationGraphTag, TAnimationGraph> : ComponentSystem where TSampleSetup : struct, ISampleSetup where TSampleData : struct, ISampleData where TAnimationGraphTag : struct, IAnimationSystemTag where TAnimationGraph : JobComponentSystem, IAnimationSystem<TAnimationGraphTag>
{
    private EntityQueryBuilder.F_EDD<Rig, TSampleSetup> m_CreateLambda;
    private EntityQueryBuilder.F_ED<TSampleData> m_DestroyLambda;
