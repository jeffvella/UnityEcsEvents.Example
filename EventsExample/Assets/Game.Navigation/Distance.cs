...
namespace Unity.PhysicsImposter
{
    ...
    static class DistanceQueries
    {
        ...
        public static unsafe Result ConvexConvex(ref ConvexHull_ convexA, ref ConvexHull_ convexB, MTransform aFromB)
        {
            return ConvexConvex(
        ...
        public static unsafe Result CapsuleCapsule(CapsuleCollider* capsuleA, CapsuleCollider* capsuleB, MTransform aFromB)
        {
            ...
            if (coreDistanceSq < distanceEpsSq)
            {
                ...
                if (math.lengthsq(normal) < 1e-5f)
                {
                    ...
                    Unity.Physics.Math.CalculatePerpendicularNormalized(edge, out normal, out float3 unused); // normal is anything perpendicular to edge
                }
                else
                {
        ...
        public static unsafe Result CapsuleTriangle(CapsuleCollider* capsuleA, PolygonCollider* triangleB, MTransform aFromB)
        {
            ...
            float3 t0 = Mul(aFromB, ((Collider_*)triangleB)->ConvexHull.Vertices[0]);
            float3 t1 = Mul(aFromB, ((Collider_*)triangleB)->ConvexHull.Vertices[1]);
            float3 t2 = Mul(aFromB, ((Collider_*)triangleB)->ConvexHull.Vertices[2]);
            ...
            {
                // Calculate triangle edges and edge planes
                float3 faceNormal = math.mul(aFromB.Rotation, ((Collider_*)triangleB)->ConvexHull.Planes[0].Normal);
        ...
        public static unsafe Result ConvexConvex(Collider_* convexA, Collider_* convexB, MTransform aFromB)
        {
            Result result;
            bool flip = false;
            switch (convexA->Type)
            {
                case ColliderType.Sphere:
                    ...
                    switch (convexB->Type)
                    {
                        ...
                        case ColliderType.Convex:
                            result = ConvexConvex(ref ((Collider_*)sphereA)->ConvexHull, ref ((Collider_*)convexB)->ConvexHull, aFromB);
                            break;
                        default:
                ...
                case ColliderType.Capsule:
                    ...
                    switch (convexB->Type)
                    {
                        ...
                        case ColliderType.Cylinder:
                        case ColliderType.Convex:
                            result = ConvexConvex(ref ((Collider_*)capsuleA)->ConvexHull, ref ((Collider_*)convexB)->ConvexHull, aFromB);
                            break;
                        default:
                            throw new NotImplementedException();
                    }
                ...
                case ColliderType.Triangle:
                    ...
                    switch (convexB->Type)
                    {
                        ...
                        case ColliderType.Cylinder:
                        case ColliderType.Convex:
                            result = ConvexConvex(ref ((Collider_*)triangleA)->ConvexHull, ref ((Collider_*)convexB)->ConvexHull, aFromB);
                            break;
                        default:
                            throw new NotImplementedException();
                    }
                ...
                case ColliderType.Box:
                    ...
                    switch (convexB->Type)
                    {
                        ...
                        case ColliderType.Cylinder:
                        case ColliderType.Convex:
                            result = ConvexConvex(ref ((Collider_*)boxA)->ConvexHull, ref ((Collider_*)convexB)->ConvexHull, aFromB);
                            break;
                        default:
                            throw new NotImplementedException();
                    }
                ...
                case ColliderType.Cylinder:
                case ColliderType.Convex:
                    result = ConvexConvex(ref ((Collider_*)convexA)->ConvexHull, ref ((Collider_*)convexB)->ConvexHull, aFromB);
                    break;
                default:
                    throw new NotImplementedException();
            }
            ...
            switch (target->Type)
            {
                ...
                case ColliderType.Quad:
                    ...
                    result = QuadSphere(
                        ...
                        input.Position, 0.0f, MTransform.Identity);
                    break;
                case ColliderType.Convex:#1#
                case ColliderType.Box:
                case ColliderType.Cylinder:
                    ref ConvexHull_ hull = ref ((Collider_*)target)->ConvexHull;
                    result = Unity.Physics.ConvexConvex(hull.VerticesPtr, hull.NumVertices, hull.ConvexRadius, &input.Position, 1, 0.0f, MTransform.Identity);
                    break;
        ...
        {
            private readonly UnityEngine.Mesh* m_Mesh;
            ...
            {
                m_Mesh->GetPrimitive(primitiveKey, out float3x4 vertices, out UnityEngine.Mesh.PrimitiveFlags flags, out CollisionFilter filter);
                ...
                int numPolygons = UnityEngine.Mesh.GetNumPolygonsInPrimitive(flags);
                bool isQuad = UnityEngine.Mesh.IsPrimitveFlagSet(flags, UnityEngine.Mesh.PrimitiveFlags.IsQuad);
                ...
                where T : struct, ICollector<DistanceHit>
            {
                ...
                ref ConvexHull_ inputHull = ref ((ConvexCollider*)input.Collider)->ConvexHull;
                MTransform targetFromQuery = new MTransform(input.Transform);
            ...
            where T : struct, ICollector<DistanceHit>
        {
            ...
            UnityEngine.Terrain.QuadTreeWalker walker;
            {
                ...
                walker = new UnityEngine.Terrain.QuadTreeWalker(&terrainCollider->Terrain, queryAabb);
            }
