...
namespace Navigation.Scripts.Region
{
    ...
    public struct SimpleBounds : IEquatable<SimpleBounds>
    {
        ...
        public Vector3[] Points => new[] {Center + new Vector3(Extents.x, Extents.y, Extents.z), Center + new Vector3(Extents.x, Extents.y, -Extents.z), Center + new Vector3(Extents.x, -Extents.y, Extents.z), Center + new Vector3(Extents.x, -Extents.y, -Extents.z), Center + new Vector3(-Extents.x, Extents.y, Extents.z), Center + new Vector3(-Extents.x, Extents.y, -Extents.z), Center + new Vector3(-Extents.x, -Extents.y, Extents.z), Center + new Vector3(-Extents.x, -Extents.y, -Extents.z)};
        ...
        public static bool operator ==(SimpleBounds lhs, SimpleBounds rhs)
        {
        ...
        public static bool operator !=(Bounds lhs, SimpleBounds rhs)
        {
            return !(lhs == rhs);
        }
        ...
        public static bool operator !=(SimpleBounds lhs, Bounds rhs)
        {
            return !(lhs == rhs);
        }
        ...
        {
            return Min.x <= (double) bounds.Max.x && Max.x >= (double) bounds.Min.x && Min.y <= (double) bounds.Max.y && Max.y >= (double) bounds.Min.y && Min.z <= (double) bounds.Max.z && Max.z >= (double) bounds.Min.z;
        }
        ...
        {
            return vecPoint.x > Min.x && vecPoint.x < Max.x && vecPoint.y > Min.y && vecPoint.y < Max.y && vecPoint.z > Min.z && vecPoint.z < Max.z;
        }
    }
}