...
public class Parameters
{
    ...
    {
        get => _animator.GetFloat(Keys.GroundDistance);
        set => SetFloat(Keys.GroundDistance, value);
    }

    public float JumpLeg
    {
        get => _animator.GetFloat(Keys.JumpLeg);
        set => SetFloat(Keys.JumpLeg, value);
    }

    public float Forward
    {
        get => _animator.GetFloat(Keys.Forward);
        set => SetDampedFloat(Keys.Forward, value);
    }

    public float Turn
    {
        get => _animator.GetFloat(Keys.Turn);
        set => SetDampedFloat(Keys.Turn, value);
    }

    public bool OnGround
    {
        get => _animator.GetBool(Keys.OnGround);
        set => _animator.SetBool(Keys.OnGround, value);
    }

    public bool OnLink
    {
        get => _animator.GetBool(Keys.OnLink);
