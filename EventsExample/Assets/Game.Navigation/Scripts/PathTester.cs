...
public class PathTester : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        Areas = new AreaDefinitions<NodeFlags> {{NodeFlags.Combat, 0.4f}, {NodeFlags.Avoidance, -2f}, {NodeFlags.NearEdge, -0.5f}};
    ...
    public void UpdatePath()
    {
        ...
        {
            if (PathFinder == null)
                PathFinder = new BurstAStarPathFinder(GridManager.Grid) {Areas = Areas, Grid = GridManager.Grid};
    ...
    public void GetPath()
    {
        ...
        if (!PathFinder.Grid.InnerGrid.IsCreated)
