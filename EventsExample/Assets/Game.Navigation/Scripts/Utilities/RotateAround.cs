...
public class RotateAround : MonoBehaviour
{
    ...
    private void Update()
    {
        if (RotateAroundObject != null)
            ...
            transform.Rotate(new Vector3(RotationMask.x * RotationSpeed * Time.deltaTime, RotationMask.y * RotationSpeed * Time.deltaTime, RotationMask.z * RotationSpeed * Time.deltaTime));
    }
}